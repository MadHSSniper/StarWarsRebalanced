...
public class PlanetTypes {
    ...
    public static final String VOLCANIC = "lava";
    public static final String VOLCANIC_MINOR = "lava_minor";
    public static final String FROZEN = "frozen";
    public static final String FROZEN_1 = "frozen1";
    public static final String FROZEN_2 = "frozen2";
    public static final String FROZEN_3 = "frozen3";
    public static final String BARREN = "barren";
    public static final String BARREN_CASTIRON = "barren_castiron";
    public static final String BARREN_2 = "barren2";
    public static final String BARREN_3 = "barren3";
    public static final String BARREN_VENUS = "barren_venuslike";
    ...
    public static final String DESERT_1 = "desert1";
