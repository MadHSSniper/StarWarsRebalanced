...
public class MustafarSystem implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        PlanetAPI star = system.initStar("mustafarStar", StarTypes.YELLOW, 400f, 200);
        star.setName("Mustafar");
        system.setLightColor(new Color(255, 250, 250));

        system.getLocation().set(SW_SystemCalculator.calcX(267), SW_SystemCalculator.calcY(-14770));

        PlanetAPI mustafar = system.addPlanet("MustafarPlanet", star, "Mustafar", "lava", 25, 122, 6000, 365);
        mustafar.setFaction("galacticempire");
        ...
        JumpPointAPI mustafarJumpPoint = Global.getFactory().createJumpPoint("MustafarJumpPoint", "Mustafar Jump-Point");
        OrbitAPI orbit = Global.getFactory().createCircularOrbit(star, 42, 6000, 365);
        mustafarJumpPoint.setOrbit(orbit);
        mustafarJumpPoint.setRelatedPlanet(mustafar);
        mustafarJumpPoint.setStandardWormholeToHyperspaceVisual();
        system.addEntity(mustafarJumpPoint);
