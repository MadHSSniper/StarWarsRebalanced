...
public class UtapauSystem implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        PlanetAPI star = system.initStar("coruscantStar", StarTypes.YELLOW, 400f, 200);
        ...
        PlanetAPI coruscant = system.addPlanet("CoruscantPlanet", star, "Coruscant", "coruscant", 25, 122, 6000, 365);
