 ...
 */
public class CruiserBombardmentScript implements ShipSystemStatsScript
{
    private static final String BOMBARDMENT_WEAPON = "bombardment_turbolaser";
    ...
    private static final float TIME_BETWEEN_BOMBARDMENTS = 7f;
    ...
    static
    {
        BOMBARDMENT_CAPABLE_WEAPONS.add("imp_heavy_turbo");
    }
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel)
    {
        ...
        if (curTime > nextFire)
        {
            ...
            for (Iterator toFire = wepsToFire.iterator(); toFire.hasNext();)
            {
                ...
                //CombatUtils.getCombatEngine().spawnProjectile(ship, wep, BOMBARDMENT_WEAPON, wep.getLocation(),wep.getCurrAngle(), ship.getVelocity());
                Global.getCombatEngine().spawnProjectile(ship, wep, BOMBARDMENT_WEAPON, wep.getLocation(),wep.getCurrAngle(), ship.getVelocity());
